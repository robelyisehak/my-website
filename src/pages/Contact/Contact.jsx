...
import defaultProfile2 from "../../assets/images/profile-2.jpg";

export default function Contact() {
  const [contactPhoto, setContactPhoto] = useState(defaultProfile2);

  useEffect(() => {
    const loadPhoto = () => {
      const savedPhoto = getPhoto("contactPhoto", defaultProfile2);
      setContactPhoto(savedPhoto);
    };
    
    loadPhoto();
    
    const handleStorageChange = (e) => {
      if (e.key === "admin_contactPhoto") {
        loadPhoto();
      }
    };
