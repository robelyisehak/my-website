...
import defaultProfileAbout from "../../assets/images/profile_about.jpg";  // ✅ Correct import

export default function HomeHero() {
  const { name, title, tagline } = homeData.hero;
  const [profileAbout, setProfileAbout] = useState(defaultProfileAbout);

  useEffect(() => {
    const loadPhoto = () => {
      const savedPhoto = getPhoto("homeHeroPhoto", defaultProfileAbout);
      setProfileAbout(savedPhoto);
    };
