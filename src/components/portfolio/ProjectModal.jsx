...
import { getProjectScreenshots } from "../../utils/helpers";
...
export default function ProjectModal({ project, isOpen, onClose }) {
  ...
  useEffect(() => {
    if (project?.screenshots && project?.id) {
      const savedScreenshots = getProjectScreenshots(project.id, project.screenshots);
      setScreenshots(savedScreenshots.length > 0 ? savedScreenshots : project.screenshots);
    }
  }, [project]);
