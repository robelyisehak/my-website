...
Passionate about delivering clean, scalable, and visually engaging solutions that improve user experience. Open to freelance or full-time opportunities in frontend development.`
  ...
  contact: {
    phone: "+251-943-273-092",
    email: "robelyisehak171@gmail.com",
    location: "Addis Ababa, Ethiopia",
    linkedin: "https://linkedin.com/in/robel25"
  },
  education: {
  ...
  certifications: [
    { name: "Programming Fundamentals", issuer: "Udacity", date: "Sep 2024" },
    { name: "Leadership", issuer: "EVASU", date: "2024" }
  ],
  languages: [
    { name: "Amharic", level: "Native", color: "text-green-400" },
    { name: "English", level: "Professional Proficiency", color: "text-cyan-400" }
  ],
  featuredProjects: [
    { title: "Online Brokerage Management System", tech: "PHP • MySQL • JavaScript" },
    { title: "Vehicle Management System", tech: "PHP • MySQL • Responsive UI" },
    { title: "Personal Portfolio Website", tech: "React • Tailwind • Vite" }
  ]
};
