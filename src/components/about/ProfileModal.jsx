...
import { getPhoto, downloadCV } from "../../utils/helpers";
import defaultProfileModalPhoto from "../../assets/images/profile-2.jpg";

export default function ProfileModal({ isOpen, onClose }) {
  const [profileModalPhoto, setProfileModalPhoto] = useState(defaultProfileModalPhoto);

  useEffect(() => {
    const loadPhoto = () => {
      const savedPhoto = getPhoto("aboutProfileModalPhoto", defaultProfileModalPhoto);
      setProfileModalPhoto(savedPhoto);
    };
    
    loadPhoto();
    
    const handleStorageChange = (e) => {
      if (e.key === "admin_aboutProfileModalPhoto") {
        loadPhoto();
      }
    };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-800/50 rounded-xl p-6 border border-green-500/20">
                  ...
                  <div className="space-y-4 text-lg">
                    ...
                    <button 
                      onClick={downloadCV}
                      className="flex items-center gap-3 text-gray-300 hover:text-green-400 transition w-full text-left"
                    >
